                ...
                Mercury = new OPlanet("Mercury", Manager.mod, Sol,
                                new Orbit(57600f, 0.205630f, 7.00487f
                                                * Mathf.degreesToRadians,
                                                ...
                                                Sol),
                                3.3011e-1f, 2.44f);
		Sol.meshLoader = () -> new ICPMesh(Sol, OShaders.icpT, 4,
                                new Texture(path.child("sol.png")));
                ...
                Earth = new OPlanet("Earth", Manager.mod, Sol,
                                new Orbit(149598.023f, 0.0167086f, 7.155f
                                                * Mathf.degreesToRadians,
                                                ...
                                                1.753434f, Sol),
                                5.97237f, 6.371f);
                Earth.meshLoader = () -> new ICPMesh(Earth, OShaders.icpT, 2,
                ...
                Moon.meshLoader = () -> new ICPMesh(Moon, OShaders.icpT, 2,
